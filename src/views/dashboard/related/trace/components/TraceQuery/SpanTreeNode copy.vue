...
<template>
  <div class="trace-timeline-item flex-v">
    ...
    <div class="trace-timeline-children" v-if="span.spans && span.spans.length > 0">
      <SpanTreeNode v-for="child in span.spans" :key="child.id" :span="child" :trace="trace" />
    </div>
  </div>
</template>
